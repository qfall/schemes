...
/// # Examples
/// ```
/// use qfall_schemes::identity_based_encryption::{DualRegevIBE, IBEScheme};
...
impl DualRegevIBE {
    ...
    /// # Examples
    /// ```
    /// use qfall_schemes::identity_based_encryption::DualRegevIBE;
    ///
...
impl IBEScheme for DualRegevIBE {
    ...
    /// # Examples
    /// ```
    /// use qfall_schemes::identity_based_encryption::{IBEScheme, DualRegevIBE};
    /// let mut ibe = DualRegevIBE::default();
...
mod test_dual_regev_ibe {
    ...
    use crate::identity_based_encryption::IBEScheme;
    use qfall_math::integer::Z;
