...
/// # Examples
/// ```
/// use qfall_schemes::pk_encryption::{DualRegevWithDiscreteGaussianRegularity, PKEncryptionScheme};
...
impl DualRegevWithDiscreteGaussianRegularity {
    ...
    /// # Examples
    /// ```
    /// use qfall_schemes::pk_encryption::DualRegevWithDiscreteGaussianRegularity;
    ///
