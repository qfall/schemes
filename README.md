...
[![CI](https://github.com/qfall/schemes/actions/workflows/push.yml/badge.svg?branch=dev)](https://github.com/qfall/schemes/actions/workflows/pull_request.yml)
...
This library is distributed under the **Mozilla Public License Version 2.0** which can be found here [License](https://github.com/qfall/schemes/blob/dev/LICENSE).
...
@misc{qFALL-schemes,
    ...
    howpublished = {Online: \url{https://github.com/qfall/schemes}},
    month = Mar,
    year = 2023,
